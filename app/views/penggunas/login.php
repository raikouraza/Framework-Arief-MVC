...
<div class="row">
    <div class="col-md-6 mx-auto">
        ...
        <?php flash('register_success');?>
            <h2>Login</h2>
            <p>Please fill in your credentials to login form</p>
            <form action="<?php echo URLROOT;?>/penggunas/login" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URLROOT;?>/penggunas/register" class="btn btn-light btn-block">Don't have an account? Register!</a>
                    </div>
                </div>
            </form>
        </div>
